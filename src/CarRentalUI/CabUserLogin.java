 ...
 */
public class CabUserLogin extends javax.swing.JFrame {

    /**
     * Creates new form CabUserLogin
     */
    public CabUserLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnULogin.setBackground(new java.awt.Color(153, 204, 255));
        ...
        getContentPane().add(btnULogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 300, 100, 40));

        btnUBack.setBackground(new java.awt.Color(153, 204, 255));
        ...
        getContentPane().add(btnUBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, 90, 40));

        lblTitle.setFont(new java.awt.Font("Helvetica Neue", 3, 24)); // NOI18N
        lblTitle.setText("USER LOGIN");
        getContentPane().add(lblTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 50, -1, -1));

        lblUUsername.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        lblUUsername.setText("USERNAME:");
        getContentPane().add(lblUUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 130, -1, -1));

        lblUDob.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        lblUDob.setText("DOB:");
        getContentPane().add(lblUDob, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, -1, -1));
        ...
        getContentPane().add(txtUUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 119, -1));
        ...
        getContentPane().add(jUPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 190, 119, -1));
        ...
        getContentPane().add(btnRegister, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, 120, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CarRentalUI/T2.jpeg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-560, -20, -1, 480));
    ...
    private void btnULoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnULoginActionPerformed
        ...
        try {
            ...
            if(rs.next()) {
                ...
                CabRentalUserRentalMenu umm = new  CabRentalUserRentalMenu();
                umm.show();
                dispose();
            ...
            Logger.getLogger(CabUserLogin.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
       ...
       CustomerRegistration ur = new  CustomerRegistration();
        this.hide();
        ur.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CabUserLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CabUserLogin().setVisible(true);
            }
        });
    }
